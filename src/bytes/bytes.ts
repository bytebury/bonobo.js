/**
 * Helpers around converting bytes to various kinds of byte sizing.
 *
 * All functions return their size in bytes.
 *
 * @example
 * ByteSize.bytes(10_000); // 10_000
 * ByteSize.megabytes(5); // 5_242_880
 */
